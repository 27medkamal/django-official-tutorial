...
def create_question(question_text, days):
    """
    Creates a question with the given 'question_text' and published the given number 'days' offset to now (negative for
...
class QuestionIndexResultsTests(TestCase):
    ...
    def test_results_view_with_a_past_question(self):
        """
        The results view of a question with a pub_date in the past should display the question's results.
        """
